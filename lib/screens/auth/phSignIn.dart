...
class nSignIn extends StatefulWidget {
  final String phone;
  nSignIn(this.phone);

  @override
  State<nSignIn> createState() => _nSignInState();
}

class _nSignInState extends State<nSignIn> {
  @override
...
class HomeScreen extends State<OTPHomeScreen> { //StatelessWidget {
  String? _enteredOTP;
  String _phoneNumber = GlobalData.whoami.mobile ?? "";

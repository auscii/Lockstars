...
import 'package:lockstars_app/services/qrscanning_initUnlock.dart';
import 'package:lockstars_app/shared/constants.dart';
import 'package:lockstars_app/shared/globals.dart';
import 'package:provider/provider.dart';

class initOpenLockerPage extends StatefulWidget {
  initOpenLockerPage({Key? key, required this.uid}) : super(key: key);
...
class _MyHomePageState extends State<initOpenLockerPage> {
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10.0),
                    Text(
                      "The initiator may unlock the door to deliver the parcel.",
                      style: TextStyle(fontSize: 16.0),
                    ),
                    SizedBox(height: 20.0),
                    TextButton(
